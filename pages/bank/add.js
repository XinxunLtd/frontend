...
export default function BankAdd() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      <Head>
        <title>{applicationData?.name || 'XinXun'} | Tambah Rekening Bank</title>
        <meta name="description" content={`${applicationData?.name || 'XinXun'} Add Bank Account`} />
        ...
        <div className="max-w-md mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${primaryColor}15` }}>
              <Icon icon="mdi:bank-plus" className="w-5 h-5" style={{ color: primaryColor }} />
            </div>
            <h1 className="text-base font-bold text-gray-900">Tambah Rekening</h1>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl p-4 border border-gray-200 mb-4">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-blue-50">
              <Icon icon="mdi:bank-plus" className="text-xl text-blue-600" />
            </div>
            <div>
              <h2 className="text-base font-bold text-gray-900 mb-1">Rekening Baru</h2>
              <p className="text-sm text-gray-600">Tambahkan rekening untuk penarikan dana</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl border border-blue-200 p-4">
          ...
          <div className="space-y-2.5">
            <div className="flex items-start gap-2">
              ...
              <p className="text-xs text-gray-700 leading-relaxed">Pastikan nama pemilik rekening sesuai dengan identitas Anda</p>
            </div>
            <div className="flex items-start gap-2">
              <Icon icon="mdi:shield-check" className="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" />
              <p className="text-xs text-gray-700 leading-relaxed">Rekening harus aktif dan dapat menerima transfer</p>
            </div>
            <div className="flex items-start gap-2">
              <Icon icon="mdi:refresh" className="w-4 h-4 text-purple-600 mt-0.5 flex-shrink-0" />
              <p className="text-xs text-gray-700 leading-relaxed">Periksa kembali data sebelum menambahkan</p>
            </div>
          </div>
        </div>
