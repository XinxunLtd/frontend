                            ...
                            >
                                <div
                                    className={`relative max-w-[80%] rounded-2xl px-4 py-3 text-sm shadow-sm ${isUser
                                        ? 'rounded-br-none bg-[#fe7d17] text-white'
            ...
            <div className="border-t border-gray-100 bg-white p-4 dark:border-slate-800 dark:bg-slate-900">
                <form onSubmit={handleSubmit} className="flex items-end space-x-2">
                    ...
                    <button
                        ...
                        className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-[#fe7d17] text-white shadow-sm transition-colors hover:bg-[#e66e10] disabled:bg-gray-300 disabled:cursor-not-allowed dark:disabled:bg-slate-700"
                    >
